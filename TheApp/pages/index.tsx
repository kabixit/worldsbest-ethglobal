...
const HomePage = () => {
  ...
  const votingSystemAddress = "0x4BE413C64db50FB52A73e7521e9AaC5438C66bB8";
  ...
  const { contract: votingSystemContract } = useContract('0x4BE413C64db50FB52A73e7521e9AaC5438C66bB8'); // Replace with your voting system contract address
